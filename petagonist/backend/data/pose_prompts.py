...
Mirrored on the frontend in `src/utils/posePrompts.js`. When variants are
generated we randomly sample 8–12 of these; the real ComfyUI pipeline will
feed each as part of the Tintin LoRA prompt.
"""
...
POSE_PROMPTS: list[str] = [
    ...
    "sitting beside an accordion on the ground in a plaza",
    ...
    "sniffing fruit crates at an outdoor market",
